# age-depth plot 
# figure 2 
# trying to construct from scratch, can't track down the original file (?)
...
site_data <- read.csv(here("data/char_samples.csv"))


ggplot(site_data, aes(x = calendar.age, y = Depth)) + geom_point() +
